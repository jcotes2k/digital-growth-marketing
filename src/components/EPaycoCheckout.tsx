...
const PLAN_DETAILS = {
  pro: { name: 'PRO', price: 39, color: 'text-primary', promo: false },
  premium: { name: 'PREMIUM', price: 69, color: 'text-primary', promo: false },
  gold: { name: 'GOLD', price: 89, color: 'text-amber-500', promo: false },
};
